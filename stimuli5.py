...
class ExperimentConfig:
    ...
    VISUAL_FREQ_LOW = 12
    NUM_BLOCKS = 6
    TRIALS_PER_BLOCK = 20  # should be 40
...
def show_pre_experiment_check(win):
    ...
    checklist_text = visual.TextStim(
        ...
        text=("Hello, and welcome!\n\n"
              ...
              "Once everything is ready, please press any key to proceed."),
        color="white",
        pos=(0, 0),
        wrapWidth=1200,
    )
...
if __name__ == "__main__":
    ...
    resting_state_eyes_open = RestingState(
        win, trigger_sender, duration=10, eyes_open=True)
    resting_state_eyes_open.start()  # Eye open phase

    resting_state_eyes_closed = RestingState(
        win, trigger_sender, duration=10, eyes_open=False)
    ...
    training_text = visual.TextStim(
        ...
        text=("Resting state phase complete. Welcome to the training session!\n\n"
              "This training session is designed to familiarize you with the visual and auditory stimuli\n"
              "that will be important for the main experiment.\n\n"
    ...
    transition_text = visual.TextStim(
        win, text="Resting state phase is complete. Thank you, and goodbye!", color="white", pos=(0, 0))
